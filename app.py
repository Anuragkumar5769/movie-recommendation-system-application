...
def main(movie_name):
        if movie_name not in movies_name_list:
            ...
            return render_template('negative.html',movie_type=movietypes,movieid=movieid,movie_overview=moviedetails,year=dat,Ratings=rating,movie_title=tit)
            ...
            return render_template('content.html',movie_type=types,movieid=mid,movie_overview=overview,year=dates,Ratings=ratings,movie_title=names,search_name=m_name)
